...
\begin{table}[H]
    ...
    \hline
    PAM & \multicolumn{2}{c|}{A} & \multicolumn{2}{c|}{B} & \multicolumn{2}{c|}{C} & \multicolumn{2}{c}{D} \\ 
    \hline
    Model & Max Error & RMSE & Max Error & RMSE & Max Error & RMSE & Max Error & RMSE \\ 
    \hline
    \hline
...
\begin{table}[H]
    ...
    \hline
    PAM& \multicolumn{2}{c|}{Agonist} & \multicolumn{2}{c}{Antagonist} \\ 
    \hline
    Measurement & Max Error & RMSE  & Max Error  & RMSE  \\ 
    \hline
    \hline
    Model & 8.82 & 5.24 & 5.86 & 5.02 \\ 
