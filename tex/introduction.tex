...
We determine the degrees of the spring constant based on prior models and calculate its coefficients experimentally.
The effectiveness of the model is demonstrated by evaluating the error in length estimation when pressure varies sinusoidally.
